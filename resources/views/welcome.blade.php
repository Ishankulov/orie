...
<div class="container">
  <div class="row">
    <div class="col-lg-6 pt-5 pt-lg-0 order-2 order-lg-1 d-flex flex-column justify-content-center">
      <h1 data-aos="fade-up">Каждый день мы рады видеть вас на АЗС ОРИЁ</h1>
      <h2 data-aos="fade-up" data-aos-delay="400">Благодаря качественному топливу ваш железный конь прослужит вам долго и верно.</h2>
      <div data-aos="fade-up" data-aos-delay="800">
        <a href="#about" class="btn-get-started scrollto">Get Started</a>
      </div>
    </div>
    <div class="col-lg-6 order-1 order-lg-2 hero-img" data-aos="fade-left" data-aos-delay="200">
      <!-- <img src="img/1.png" class="img-fluid animated" alt=""> -->
      <img src="{{asset('images/slider/'.$banner->image)}}" class="img-fluid animated" alt="">
    </div>
  </div>
</div>
...
<section id="clients" class="clients clients">
  <div class="container">
    ...
    <div class="row">
      ...
      <div class="col-lg-2 col-md-4 col-6">
        <img src="img/clients/unnamed.png" class="img-fluid" alt="" data-aos="zoom-in" data-aos-delay="100">
      </div>
